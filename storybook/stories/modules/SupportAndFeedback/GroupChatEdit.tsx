  ...
  return (
    <VStack _light={{ bg: 'white' }} _dark={{ bg: 'coolGray.800' }}>
        ...
        <Pressable py="2">
          <HStack alignItems="center" space="7">
            <Center
              ...
              _dark={{ bg: { base: 'primary.900', md: 'coolGray.700' } }}
              p="2"
              rounded="full"
            >
              <Icon
      ...
      <Text
        ...
        _dark={{ color: { base: 'primary.700', md: 'coolGray.200' } }}
        px={{ base: '4', md: '8' }}
        mt="5"
        fontWeight="500"
      >
