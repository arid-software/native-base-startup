...
export default function TrainTracking(props: any) {
  let itemsList = [
    {
      ...
      >
        ...
        <HStack>
          ...
          <VStack flex={1} mt={2} ml={2}>
            ...
            <Text ml={2} color="emerald.600" fontSize={10} fontWeight="medium">
              On Time
            </Text>
            <Text
              mt={6}
            ...
            <HStack mt={86} justifyContent="space-between" alignItems="center">
              <HStack ml={2} alignItems="center">
                <Text
                  _light={{ color: 'coolGray.800' }}
                  _dark={{ color: 'coolGray.50' }}
