...
function OptionSelector(props: any) {
...
function RestaurantMobile(props: any) {
  return (
    <VStack w="100%">
      <HotelName />
      <OptionSelector />
...
function RestaurantWeb(props: any) {
  return (
    <>
      <HotelNameWeb />
      <OptionSelector />
...
function HotelNameWeb(props: any) {
  return (
    <VStack space={4}>
      <HStack alignItems="center" space={3}>
        <Image
          ...
          rounded="sm"
          source={{
            uri: require('../../assets/RestaurentOne.png'),
          }}
          alt="Alternate Text"
        />
        <VStack alignItems="center" space={2}>
          <Image
            ...
            rounded="sm"
            source={{
              uri: require('../../assets/RestaurentTwo.png'),
            }}
            alt="Alternate Text"
          />
          <Image
            ...
            rounded="sm"
            source={{
              uri: require('../../assets/RestaurentThree.png'),
            }}
            alt="Alternate Text"
          />
        </VStack>
...
function DishlistWeb(props: any) {
  return (
    <VStack
      w="100%"
      space={{ base: 3, md: 0 }}
